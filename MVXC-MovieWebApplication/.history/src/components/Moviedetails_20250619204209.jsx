...
const { id } = useParams();
  ...
  return info ?(
    <div style={{
      ...
      <img className='shadow-[8px_17px_58px_2px_rgba(0,0,0,.5)] hover:shadow-xl hover:shadow-black hover:scale-110 duration-300 rounded-md h-[35vh] object-fit' src={`https://image.tmdb.org/t/p/original/${ info.poster_path  ||info.backdrop_path ||c.profile_path }`} alt="" />
      </div>
