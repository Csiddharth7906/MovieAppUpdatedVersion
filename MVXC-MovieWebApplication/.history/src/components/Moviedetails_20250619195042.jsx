  ...
  return info ?(
    <div style={{
      ...
      <nav className='w-full h-[10vh] items-center text-zinc-100 flex gap-10 text-xl' >
        ...
        <a target='_blank' href={info.detail.homepage}><i className="  hover:text-[]   ri-external-link-line"></i></a>
        <a target='_blank' href={`https://www.wikidata.org/wiki/${info.externalid.wikidata_id}`}><i className=" hover:text-[]  ri-earth-fill"></i></a>
