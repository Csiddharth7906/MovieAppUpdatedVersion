...
const Trending = () => {
  ...
  return trending.length > 0 ? (
    <div className='w-screen h-screen  '>
        <div className='w-full px-4 md:px-8 flex items-center justify-between overflow-x-hidden'>
        ...
        <InfiniteScroll
               ...
               loader={
                    <div className="flex justify-center bg-[#1F1E24] items-center py-10">
                        ...
                        <div className="absolute inset-0 border-4 border-[#6556CD] border-t-transparent rounded-full animate-spin"></div>
