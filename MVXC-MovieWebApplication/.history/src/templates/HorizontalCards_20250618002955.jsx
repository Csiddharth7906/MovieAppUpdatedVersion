    ...
    <div className='w-full h-[40vh] p-5  '>
        ...
        <div className='w-[100%]  flex overflow-y-hidden  '>
            {data.map((d,i)=><div key={i} className='min-w-[15%] h-full mr-5 mb-5'>  
                <img className='w-full hover:shadow-lg hover:shadow-[#D2042D]  object-cover hover:scale-110 duration-300 rounded-md' src={`https://image.tmdb.org/t/p/original/${  d.poster_path||d.backdrop_path  }`} alt="" />
