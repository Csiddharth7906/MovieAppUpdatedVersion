  ...
  return (
    <div className="w-full h-[8vh] relative flex justify-start ml-[15%] items-center">
      ...
      <div className="w-[50%] max-h-[50vh] bg-zinc-200 absolute top-[90%] overflow-auto rounded-lg">
        {searches.map((s,i)=>{ return <Link key={i} className="w-[100%] font-semibold hover:text-black hover:bg-zinc-300 duration-300 text-zinc-600  p-10 flex justify-start items-center border-b-2 border-zinc-100">
