...
const HorizontalCards = ({data}) => {
  return (
    <div className='w-full h-[40vh] p-5 '>
        ...
        <div className='w-[100%] h-[55vh] flex '>
            {data.map((d,i)=><div key={i} className='min-w-[15%]  mr-5 '>  
                <img className='w-full h-[100%] object-cover' src={`https://image.tmdb.org/t/p/original/${d.backdrop_path || d.poster_path }`} alt="" />
