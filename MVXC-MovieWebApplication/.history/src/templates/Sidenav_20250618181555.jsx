  ...
  return (
    <div className="w-[20%] h-full border-r border-zinc-600 p-8 bg-[#1F1E24]">
      ...
      <nav className="text-zinc-400 text-lg flex flex-col gap-2">
        ...
        <Link to="/popular" className="hover:bg-[#D2042D] hover:scale-110     hover:text-white rounded-md transition duration-200 p-3 flex items-center">
          <i className="mr-2 ri-bard-fill"></i> Popular
        </Link>
        <Link to="/movie" className="hover:bg-[#D2042D] hover:scale-110     hover:text-white rounded-md transition duration-200 p-3 flex items-center">
          <i className="mr-2 ri-clapperboard-fill"></i> Movies
        </Link>
        <Link to="/tv" className="hover:bg-[#D2042D] hover:scale-110     hover:text-white rounded-md transition duration-200 p-3 flex items-center">
          <i className="mr-2 ri-tv-2-fill"></i> TV Shows
        </Link>
        <Link to="/person" className="hover:bg-[#D2042D] hover:scale-110     hover:text-white rounded-md transition duration-200 p-3 flex items-center">
      ...
      <nav className="text-zinc-400 text-lg flex flex-col gap-2">
        ...
        <Link className="hover:bg-[#D2042D] hover:scale-110     hover:text-white rounded-md transition duration-200 p-3 flex items-center">
