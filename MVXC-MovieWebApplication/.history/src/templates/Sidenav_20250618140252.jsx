...
const Sidenav = () => {
  ...
  return (
    <div className="w-[20%] h-full border-r border-zinc-600 p-8 bg-[#1F1E24]">
      {/* Logo */}
      <h1 className="text-2xl text-white font-bold flex items-center mb-8">
      ...
      <nav className="text-zinc-400 text-lg flex flex-col gap-2">
        ...
        <Link to="/trending" className="hover:bg-[#D2042D] hover:text-white rounded-md transition duration-200 p-3 flex items-center">
          <i className="mr-2 ri-fire-fill"></i> Trending
        </Link>
        <Link to="" className="hover:bg-[#D2042D] hover:text-white rounded-md transition duration-200 p-3 flex items-center">
