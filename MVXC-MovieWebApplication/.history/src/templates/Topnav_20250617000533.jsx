  ...
  return (
    <div className="w-full h-[8vh] relative flex justify-center items-center">
      ...
      <div className="w-[50%] h-[50vh] bg-zinc-200 absolute top-[90%]">
        <Link className="w-[100%] font-semibold hover:text-black hover:bg-zinc-300 duration text-zinc-600  p-10 flex justify-start items-center border-b-2 border-zinc-100">
