  ...
  return (
    <div className='flex flex-wrap w-full h-full py-[5%] px-6 bg-[#1F1E24] ' >
      ...
      { c.vote_average &&(
       ...
       <div className='text-white right-[-4%] bottom-[40%] absolute text-xs font-semibold w-[5vh] h-[5vh] flex justify-center rounded-full items-center bg-yellow-500'>{(c.vote_average*10).toFixed()}<sup>%</sup></div>
      )}
        </Link>)}
