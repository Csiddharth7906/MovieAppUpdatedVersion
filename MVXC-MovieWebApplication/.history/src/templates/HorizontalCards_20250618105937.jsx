  ...
  return (
        ...
        <div className='w-[100%]  flex overflow-y-hidden mb-5 p-5'>
            {data.map((d,i)=><div key={i} className='min-w-[15%] h-full mr-5 mb-5'>  
                <img className='w-full hover:shadow-xl hover:shadow-black  object-cover hover:scale-120 duration-300 rounded-md' src={`https://image.tmdb.org/t/p/original/${  d.poster_path||d.backdrop_path  }`} alt="" />
