...
const Cards = ({data,title}) => {
  return (
    <div className='flex flex-wrap w-full h-full px-[5%] bg-[#1F1E24] ' >
       ...
       <div className='text-white right-[-5%] bottom-[40%] absolute text-xl font-semibold w-[5vh] h-[5vh] flex justify-center rounded-full items-center bg-yellow-600'>{(c.vote_average*10).toFixed()}<sup>%  </sup></div>
        </Link>)}
